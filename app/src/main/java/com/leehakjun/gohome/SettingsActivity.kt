...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val savedStartTime = sharedPreferences.getString("startTime", "")
        val savedEndTime = sharedPreferences.getString("endTime", "")
        val savedStartTime2 = sharedPreferences.getString("startTime2", "") // 퇴근 시작 설정 값 가져오기
        val savedEndTime2 = sharedPreferences.getString("endTime2", "") // 퇴근 종료 설정 값 가져오기
